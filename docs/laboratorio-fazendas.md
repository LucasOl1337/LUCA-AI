...
npm run typecheck
npm run build
node --test server/lab-farm-demo.test.js server/lab-telemetry.test.js server/lab-terrain.test.js server/lab-site.test.js server/lab-cases.test.js server/sompo-lab-export.test.js server/geofencing/engine.test.js server/geofencing/piracicaba-dataset.test.js
