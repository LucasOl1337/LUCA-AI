...
- Branch integração: `swarm/LUCA-AI/bugs-integracao` @ `a1a14c3` (produto bugs ≡ execução `1e2a890` / cherry-picks até `7e23deb`)
...
## Decisão
**aprovar**. Integração local completa em `swarm/LUCA-AI/bugs-integracao` @ `a1a14c3` (produto ≡ `bugs` @ `1e2a890`).  
