...
- Branch integração: `swarm/LUCA-AI/bugs-integracao` @ `7e23deb` (produto bugs ≡ tip de execução; tip do coletor abaixo)
...
## Decisão
**aprovar**. Integração local completa em `swarm/LUCA-AI/bugs-integracao` @ `7e23deb` (produto ≡ `bugs` @ `1e2a890`).  
