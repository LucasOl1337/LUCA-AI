...
export const SOMPO_RURAL_SCRIPTS = Object.freeze({
  ...
  'engine-fire': ruralScript('engine-fire', [
    ...
    [7_000, 'Busca o acostamento', { speedKph: 24, lateral: 1.7, yaw: 5, smoke: 0.75, temperature: 54 }],
  ...
  'driver-drowsiness': ruralScript('driver-drowsiness', [
    ...
    [7_400, 'Corrige de volta', { yaw: 0 }],
    [9_500, 'Aproximação do acostamento', { yaw: 4, lateral: 1.9, roll: 2.5 }],
    [10_800, 'Recupera a direção', { yaw: -1.5, lateral: 1.85, roll: -1 }],
...
const SOMPO_OUTCOME_SCRIPTS = Object.freeze({
  ...
  obstacle: Object.freeze({
    'parada-segura': ruralScript('obstacle', [
      [0, 'Aproximação do obstáculo', { distance: 300, collisionRisk: false, speedKph: 5.5 }],
      [2_500, 'Alerta de proximidade', { distance: 138, collisionRisk: true, speedKph: 4 }],
      [4_700, 'Fechando a distância', { distance: 60, speedKph: 1.2 }],
      [6_800, 'Parada segura', { distance: 43, speedKph: 0, roughness: 0 }],
      [13_000, 'Aguardando liberação da via', {}],
    ]),
    'toque-leve': ruralScript('obstacle', [
      [0, 'Aproximação do obstáculo', { distance: 300, collisionRisk: false, speedKph: 6.5 }],
      [2_500, 'Alerta tardio', { distance: 112, collisionRisk: true, speedKph: 4.5 }],
      [4_900, 'Toque leve no obstáculo', { distance: 8, speedKph: 1.8, pitch: -2, roughness: 2.2 }],
      [6_200, 'Parado após o toque', { pitch: 1, roughness: 0, distance: 5, speedKph: 0 }],
  ...
  'hot-weather': Object.freeze({
    'pausa-preventiva': ruralScript('hot-weather', [
      ...
      [7_500, 'Busca sombra no acostamento', { speedKph: 52, lateral: 0.5, temperature: 47 }],
      [11_000, 'Frenagem suave até a sombra', { speedKph: 12, lateral: 1.7, yaw: -3 }],
      [13_000, 'Parada preventiva à sombra', { speedKph: 0, lateral: 2.9, roughness: 0, yaw: -4 }],
      [18_000, 'Resfriando à sombra', { temperature: 42, yaw: 0 }],
    ]),
  ...
  'animal-crossing': Object.freeze({
    desvio: ruralScript('animal-crossing', [
      ...
      [2_800, 'Travessia repentina', { animalZ: -1.6, distance: 120, collisionRisk: true, speedKph: 76, yaw: -1.5 }],
      [3_050, 'Nariz morde a esquerda', { animalZ: -0.9, yaw: -5, lateral: -0.15, roll: -2, speedKph: 75 }],
      ...
      [5_400, 'Na faixa oposta', { animalZ: 2.0, lateral: -3.1, yaw: 4, roll: 3, distance: 130, speedKph: 55, collisionRisk: false }],
    ...
    colisao: ruralScript('animal-crossing', [
      ...
      [5_400, 'Frenagem máxima', { animalZ: -0.3, distance: 46, speedKph: 36, pitch: -5 }],
      [6_500, 'Impacto com o animal', { animalZ: 0.05, distance: 8, speedKph: 13, pitch: -2, roughness: 3.2 }],
      [6_900, 'Parado com o animal no para-choque', { animalZ: 0.15, speedKph: 0, pitch: 0, roughness: 0.4, distance: 10 }],
  ...
  aquaplaning: Object.freeze({
    'saida-de-pista': ruralScript('aquaplaning', [
      ...
      [7_200, 'Roda cruza a borda da pista', { lateral: 3.0, yaw: 9, speedKph: 70, wheelSpeedKph: 42, roll: 3, roughness: 1.6 }],
      [9_500, 'Grama encharcada arrasta o conjunto', { lateral: 4.0, yaw: 4, speedKph: 30, wheelSpeedKph: 28, roll: 7, sink: 0.1, inclinationRisk: true, roughness: 3.0, pitch: -2 }],
      [12_000, 'Parada no campo', { speedKph: 0, wheelSpeedKph: 0, yaw: 0, lateral: 4.4, roll: 5, sink: 0.14, roughness: 0, collisionRisk: false, pitch: 0 }],
    ...
    'parada-preventiva': ruralScript('aquaplaning', [
      ...
      [8_500, 'Frenagem leve até o acostamento', { speedKph: 34, lateral: 1.5, yaw: -3 }],
  ...
  'engine-fire': Object.freeze({
    ...
    'fogo-alastra': ruralScript('engine-fire', [
      ...
      [6_800, 'Busca o acostamento', { speedKph: 26, lateral: 1.4, yaw: 4, smoke: 0.8, temperature: 55 }],
      [9_200, 'Parada de emergência no acostamento', { speedKph: 0, lateral: 2.4, yaw: 2, smoke: 0.9, temperature: 58, roughness: 0 }],
      [9_800, 'Chamas se alastram', { smoke: 1, temperature: 68, humidity: 16 }],
  ...
  'fast-corner': Object.freeze({
    tombamento: ruralScript('fast-corner', [
      ...
      [5_400, 'Tomba para fora da curva', { roll: 72, lateral: 2.2, speedKph: 30, yaw: -12, roughness: 2.4 }],
