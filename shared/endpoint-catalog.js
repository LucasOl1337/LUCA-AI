      ...
      },
      {
              ...
              inbound: [
                ...
                endpoint(
                  ...
                  'cria pasta/projeto para organizar sessões do LUCA-AI',
                  'both',
                  '{\n  "name": "LUCA AI"\n}',
                ),
                endpoint(
                  'luca-ai-chat-folder-rename',
                  'PATCH',
                  '/api/luca-ai/chat/folders/:folderId',
                  'renomeia pasta/projeto de sessões do LUCA-AI',
                  'both',
                  '{\n  "name": "Sharingan"\n}',
                ),
                endpoint(
                  'luca-ai-chat-folder-delete',
                  'DELETE',
                  '/api/luca-ai/chat/folders/:folderId',
                  'remove pasta/projeto; sessões sobem para a raiz salvo cascadeSessions',
                  'both',
                ),
                endpoint(
                  'luca-ai-chat-session-create',
                  'POST',
                  '/api/luca-ai/chat/sessions',
                  'cria e ativa uma nova sessão de chat no LUCA-AI',
                  'both',
                  '{\n  "title": "Nova sessão",\n  "folderId": null,\n  "seedFromActive": true\n}',
                ),
                endpoint(
                  'luca-ai-chat-session-update',
                  'PATCH',
                  '/api/luca-ai/chat/sessions/:sessionId',
                  'persiste título, pasta, transcript e seleção da sessão ativa',
                  'both',
                ),
                endpoint(
                  'luca-ai-chat-session-activate',
                  'POST',
                  '/api/luca-ai/chat/sessions/:sessionId/activate',
                  'troca a sessão ativa do LUCA-AI',
                  'both',
                ),
                endpoint(
