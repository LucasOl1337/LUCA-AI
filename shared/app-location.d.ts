export type AppPageId = 'inicio' | 'luca-ai' | 'personas' | 'configuracao' | 'sompo' | 'laboratorio' | 'sensor' | 'sonolencia' | 'admin';
...
export function getSompoView(location: Partial<AppLocation>): 'welcome' | 'cases' | 'telemetry' | 'fleet';
