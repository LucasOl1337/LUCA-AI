...
export const SOMPO_SCENARIO_EFFECTS = Object.freeze({
  ...
  'tire-blowout': scene([track('tire-damage', 2900, null, 1, 100), track('rubber-shards', 2980, null, 1, 0), track('blowout-dust', 2980, 5600, 1, 25), track('tire-smoke', 3200, 7600, 0.7), track('skid-marks', 3050), track('brake-lights', 4700, 9800), track('shoulder-dust', 6800, 9800, 0.5), track('hazard-lights', 4800)]),
...
export const SOMPO_SCENARIO_OUTCOME_EFFECTS = Object.freeze({
  ...
  'tire-blowout': Object.freeze({
    'saida-de-pista': scene([track('tire-damage', 2900, null, 1, 100), track('rubber-shards', 2980, null, 1, 0), track('blowout-dust', 2980, 5400, 1, 25), track('tire-smoke', 3200, 7000, 0.7), track('skid-marks', 3050), track('brake-lights', 4500, 9800), track('shoulder-dust', 5800, 10500, 0.9), track('hazard-lights', 4600)]),
    tombamento: scene([track('tire-damage', 2900, null, 1, 100), track('rubber-shards', 2980, null, 1, 0), track('blowout-dust', 2980, 5400, 1, 25), track('tire-smoke', 3200, 6200, 0.8), track('skid-marks', 3050), track('brake-lights', 4300, 6400), track('impact-dust', 7000, 11200, 1, 40), track('debris', 7000, null, 1, 0), track('hazard-lights', 8000)]),
  }),
  ...
  'engine-fire': Object.freeze({
    'fogo-contido': scene([track('engine-smoke', 1400, 10800, 1, 4000), track('exhaust', 4400, 7400, 0.8, 700), track('brake-lights', 5000, 7600), track('engine-fire', 7400, 9300, 1, 1800), track('hazard-lights', 4600), track('engine-steam', 8600, null, 0.55, 1600)]),
