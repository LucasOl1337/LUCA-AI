...
window.requestAnimationFrame = callback => rawRaf(() => {
  const start = realNow();
  fixture.time = fixture.controlled ? Math.min(fixture.until, fixture.time + 1000 / 60) : realNow();
  fixture.draws = 0; fixture.triangles = 0;
  callback(fixture.time);
  if (fixture.draws) {
    fixture.metrics.push({ at: start, cpuMs: realNow() - start, calls: fixture.draws, triangles: fixture.triangles });
