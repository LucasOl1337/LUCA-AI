...
| `src/sensor-lab/` | SOMENTE ao alterar o laboratorio 3D do sensor (`/sensor`). |
...
| [`docs/sensor-lab.md`](./docs/sensor-lab.md) | SOMENTE ao mudar o laboratorio 3D do sensor (`/sensor`). |
